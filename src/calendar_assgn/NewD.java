...
public class NewD extends javax.swing.JFrame {
    ...
    for(int i = 0; i < daysInMonth; i++)
    {
        ...
        //HIGHLIGHTS THE CURRENTLY DISPLAYED DATE
    ...
    private void initComponents() {
        ...
        borderPanel.add(currentDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 120, 140, 30));
    ...
    private void gotoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gotoButtonActionPerformed
        ...
        if(referenceDate != null)
        {
            ...
            if(GDM.matches(temp))
            {
                ...
                d1.dateChanger(newMonth, newDay, newYear);
                this.dispose();
            }
            else
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
